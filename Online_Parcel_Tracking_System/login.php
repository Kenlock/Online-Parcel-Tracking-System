        ...
        <td><div align="center">
          ...
          <table border="0" cellpadding="0" cellspacing="0" align="center" width="300">
                      ...
                      <tbody><tr>
                        <form name="form1" id="form1" method="post" onSubmit="return memloginvalidate()">
                          <td><table bgcolor="#FFFFFF" border="0" cellpadding="3" cellspacing="1" width="100%">
                              <tbody><tr>
                                <td colspan="3" class="smalltextgrey" style="height: 25px"></td>
                              </tr>
                              <tr>
			...
			?>
                  ...
                  <tr>
                    <td>
					<input name="Submit1" class="green-button" value="Back Home" type="button" style="padding:5px 10px;font-weight:bold;"><a href="offices-list.php"></td>
                  </tr>
              </tbody></table></td>
