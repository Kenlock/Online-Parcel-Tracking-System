    ...
    <td bgcolor="#FFFFFF" width="900"><table border="0" align="center" width="99%">
      <tbody><tr>
        <td width="22%"><table border="0" align="center" width="185">
          ...
          <tr bgcolor="#EFF7FC">
            <td class="aalpha" style="height: 19px"><strong><img src="home_files/arrow_right.gif" height="9" width="9"> 
			<a href="report.php" class="REDLink">Home</a></strong></td>
          </tr>
          <tr>
            <td class="aalpha" style="height: 21px"><strong><img src="home_files/arrow_right.gif" height="9" width="9"> 
			About </strong></td>
          </tr>
          <tr bgcolor="#EFF7FC">
          ...
          <tr bgcolor="#EFF7FC">
            <td class="aalpha"><strong><img src="home_files/arrow_right.gif" height="9" width="9"> Platform Requirements </strong></td>
              ...
              <p align="center"><img src="home_files/mysql.gif" height="35" width="100"></p>
		...
		Parcel and cargo management system  </strong> is the simplest solution for <strong>Courier &amp; Cargo Tracking</strong> Business. If you need to enable Tracking Option in your existing or new website, this is quickest Software Solution. </p>
          <p class="navi" align="justify">&nbsp;</p>
          <p class="navi" align="justify">&nbsp;</p>
          <p class="navi" align="justify">&nbsp;</p>
          <p class="navi" align="justify"><strong>Tagline: </strong></p>
          <p class="navi" align="justify">" we are commited to meet our changing day-to-day delivery needs" </p></td>
